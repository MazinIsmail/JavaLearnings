...
/*
 * TREESET
 * Elements will be sorted(default: ascending order)
 ...
 * TreeSet duplicate values are not allowed.
 * TreeSet is basically implementation of a self-balancing binary search tree like Red-Black Tree. 
 * The elements in a TreeSet are sorted as per their natural ordering, 
 * 		or based on a custom Comparator that is supplied at the time of creation of the TreeSet.
