...
public class TreesetMethods2 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Higher() : This method returns the least element in the TreeSet which is
		 * strictly greater than the given element in the argument of this method, or it
		 * will return null if there is no such element
		 */
		System.out.println("highest value than 7 :  " + treeSetObject1.higher(7));

		/*
		 * isEmpty() : This method returns true if the set is empty or false if set
		 * contains any element
		 */
		System.out.println("Is Tree Set empty ? " + treeSetObject1.isEmpty());

		/*
		 * iterator(): This method gives an object of Iterator class by which we can
		 * retrieve list
		 */
		...
		// TODO: floor vs lower
		/*
		 * lower(Object o): This method returns the greatest element in this treeset
		 * which is strictly less than the given element in the set
		 */
		...
		// subSet(Object fromElement, boolean fromInclusive, Object toElement, boolean
		// toInclusive):
		...
		/*
		 * SortedSet subSet(Object fromElement, Object toElement): Default : inclusive :
		 * true , false
		 */
