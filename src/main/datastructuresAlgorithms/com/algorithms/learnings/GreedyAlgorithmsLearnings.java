 ...
 * possible coin. If we are provided coins of 1, 2, 5 and 10 and we are asked to
 ...
 * use more coins than necessary. For example, the greedy approach will use 10 +
 * 1 + 1 + 1 + 1 + 1, total 6 coins. Whereas the same problem could be solved by
 * using only 3 coins (7 + 7 + 1)
 * 
 ...
 */
public class GreedyAlgorithmsLearnings {
