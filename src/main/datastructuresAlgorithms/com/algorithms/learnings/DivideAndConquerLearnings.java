 ...
 * possible sub-problem (fractions) are solved. The solution of all sub-problems
 ...
 * 
 * Divide/Break: This step involves breaking the problem into smaller
 * sub-problems. Sub-problems should represent a part of the original problem.
 * This step generally takes a recursive approach to divide the problem until no
 * sub-problem is further divisible. At this stage, sub-problems become atomic
 * in nature but still represent some part of the actual problem.
 * 
 * Conquer/Solve: This step receives a lot of smaller sub-problems to be solved.
 ...
 * recursively combines them until they formulate a solution of the original
 * problem. This algorithmic approach works recursively and conquer & merge
 ...
 * Closest pair (points)
 */
public class DivideAndConquerLearnings {
